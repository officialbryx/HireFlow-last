...
const ApplicationDetails = () => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case "rejected":
        return "bg-white text-red-800 border border-red-300";
      case "shortlisted":
        return "bg-white text-blue-800 border border-blue-300";
      case "interview":
        return "bg-white text-purple-800 border border-purple-300";
      case "pending":
        return "bg-white text-yellow-800 border border-yellow-300";
      default:
  ...
  const getStatusMessage = (status) => {
    if (isJobArchived()) {
      return "This job posting has been archived by the employer and is no longer accepting applications. Please check other available positions.";
    }

    switch (status) {
      case "accepted":
      case "approved":
        return "Congratulations on being selected for this position! Our HR team will contact you shortly with further details regarding the onboarding process and next steps. Please ensure your contact information is up to date to facilitate smooth communication.";

      case "rejected":
        return "After careful consideration, we have decided to move forward with other candidates whose qualifications better match our current requirements. This decision does not reflect on your capabilities. We encourage you to apply for future positions that align with your skills and experience.";

      case "shortlisted":
        return "Your application has been shortlisted for further consideration. The hiring team was impressed with your qualifications and experience. Next steps: • Your application will undergo further review • You may be contacted for additional information or assessments • Please respond promptly to any communications";

      case "interview":
        return "Congratulations! You have been selected for an interview. Our hiring team will contact you shortly to schedule a convenient time. Interview preparation: • Research our company and the role • Review the job requirements • Prepare relevant examples of your experience • Have questions ready for the interviewer";

      case "pending":
        return "Your application is currently under review by our hiring team. Important information: • Typical review process: 1-2 weeks • Check dashboard for status updates • We will contact you if additional information is needed";

      default:
        return `Application status: ${status}. Please refer to your dashboard for the most current information. Contact HR team for any questions.`;
    }
  };
          ...
          <div className="bg-white shadow-xl rounded-xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-2xl">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div className="mt-4 md:mt-0">
                  {isJobArchived() ? (
                    ...
                    <span
                      className={`px-4 py-2 inline-flex text-md leading-5 font-semibold rounded-full ${getStatusBadge(
                        application?.status
                      )}`}
                    >
                      {application?.status &&
            ...
            {!isInactive() && applicationStep !== -1 && (
              <div className="px-8 py-5 border-b border-gray-200 bg-white">
                ...
                <div className="relative">
                  <div
                    className="absolute left-0 top-4 w-full h-1 bg-gray-200"
                    aria-hidden="true"
                  ></div>
            ...
            <div className="px-8 py-6 border-t border-gray-200 bg-gray-50 flex justify-end">
              ...
              {application?.status !== "rejected" &&
                ...
                !isJobArchived() && (
                  <button
                    className={`text-sm bg-red-50 text-red-600 hover:bg-red-100 px-4 py-2 rounded-md transition-all flex items-center ${
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          We recommend you continue exploring other
                          opportunities while you wait. Don&apos;t forget to set
                          up job alerts to stay updated on similar positions.
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {application?.status === "shortlisted" && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          Shortlisted candidates may be asked to complete skills
                          assessments. Review your qualifications and be ready
                  ...
                  {application?.status === "interview" && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          Research the company thoroughly, prepare answers to
                          common interview questions, and think of insightful
                          questions to ask your interviewer. Dress
                          professionally and arrive early.
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {(application?.status === "accepted" ||
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          Congratulations! Review any documents sent by the
                          employer and prepare for your first day. Make sure
                          your contact information is up to date so you don't
